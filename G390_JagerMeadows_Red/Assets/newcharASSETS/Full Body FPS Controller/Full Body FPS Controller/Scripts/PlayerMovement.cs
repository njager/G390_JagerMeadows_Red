...
namespace EasySurvivalScripts
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        IEnumerator PerformJumpRoutine()
        {
            //play jump sound
            if (_audioSource)
                _audioSource.PlayOneShot(JumpSounds[Random.Range(0, JumpSounds.Count)],0f);
            ...
            //play land sound
            if (_audioSource)
                _audioSource.PlayOneShot(LandSounds[Random.Range(0, LandSounds.Count)],0f);
        ...
        void PlayFootstepSounds()
        {
            ...
            {
                footstep_et = 0;
                _audioSource.PlayOneShot(FootstepSounds[Random.Range(0, FootstepSounds.Count)] ,0f);
            }
        }
